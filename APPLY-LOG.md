...
| 2026-09-18 | ImagineArt | Agent Infrastructure Engineer — Core Harness (Superagent) | Phase C soft remote IN | Ashby | **READY** — pack + `Muhammad_Ahmed_ImagineArt_Agent_Infrastructure.pdf` · `daily/2026-09-18/01-imagineart/` | — | Fill form · attach PDF · Submit (computerUse) |
| 2026-09-18 | ClickUp | Senior Software Engineer, Internally Deployed Products | Phase C soft remote US | Ashby | **READY** — pack + `Muhammad_Ahmed_ClickUp_Internally_Deployed_Products.pdf` · `daily/2026-09-18/02-clickup/` | — | Fill form · attach PDF · Submit (computerUse) |
| 2026-09-18 | OpenArt | Software Engineer, Agent | Phase C soft hybrid SF | Ashby | **READY** — pack + `Muhammad_Ahmed_OpenArt_Software_Engineer_Agent.pdf` · `daily/2026-09-18/03-openart/` | — | Fill form · attach PDF · Submit (computerUse) |
| 2026-09-18 | Output | Software Engineer, Agents | Phase C soft onsite NYC | Ashby | **READY** — pack + `Muhammad_Ahmed_Output_Software_Engineer_Agents.pdf` · `daily/2026-09-18/04-output/` | — | Fill form · attach PDF · Submit (computerUse) |
| 2026-09-18 | Intangible | Applied AI/ML Engineer | Phase C soft remote NA/EU TZ | Ashby | **READY** — pack + `Muhammad_Ahmed_Intangible_Applied_AI_ML.pdf` · `daily/2026-09-18/05-intangible/` | — | Fill form · attach PDF · Submit (computerUse) |
