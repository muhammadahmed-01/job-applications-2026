...
| 2026-09-19 | Fieldguide | Software Engineer, Agents (Foundation Agents) | Phase C soft hybrid SF | Ashby | **READY** — pack + `Muhammad_Ahmed_Fieldguide_Software_Engineer_Agents.pdf` · SF relocate No · sponsorship Yes · essays live | — | computerUse fill+Submit |
| 2026-09-19 | Axelera AI | AI Systems Engineer - Agents & Inference | Phase C soft hybrid NL | Ashby | **READY** — pack + `Muhammad_Ahmed_Axelera_AI_Systems_Engineer_Agents.pdf` · CV deploy No honest · agentic harness Yes | — | computerUse fill+Submit |
| 2026-09-19 | Sticker Mule | AI agent engineer | Phase C soft remote | Ashby | **READY** — pack + `Muhammad_Ahmed_StickerMule_AI_Agent_Engineer.pdf` · Remote solely | — | computerUse fill+Submit |
| 2026-09-19 | Arena Intelligence | Applied AI Engineer | Phase C soft hybrid Bay Area | Ashby | **READY** — pack + `Muhammad_Ahmed_Arena_Applied_AI_Engineer.pdf` · US auth No · sponsorship Yes | — | computerUse fill+Submit |
